...
RegisterServerEvent('PlusCore:DebugSomething', function(tbl, indent)
...
function PlusCoreDebug(tbl, indent)
    TriggerEvent('PlusCore:DebugSomething', tbl, indent)
end

function PlusCoreShowError(resource, msg)
    print('\x1b[31m[' .. resource .. ':ERROR]\x1b[0m ' .. msg)
end

function PlusCoreShowSuccess(resource, msg)
