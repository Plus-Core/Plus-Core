...
ToggleNoClip = function(state)
    ...
    PlusCore.func.Notify(IsNoClipping and Lang:t("success.noclip_enabled") or Lang:t("success.noclip_disabled"))
...
RegisterNetEvent('plus-admin:client:ToggleNoClip', function()
