...
function closeMenu() {
  ...
  $.post('https://plus-hud/closeMenu');
}
function restartHud() {
  closeMenu()
  $.post('https://plus-hud/restartHud');
}
function resetStorage() {
  closeMenu()
  $.post('https://plus-hud/resetStorage');
}
function showOutMap() {
  $.post('https://plus-hud/showOutMap');
}
function showOutCompass() {
  $.post('https://plus-hud/showOutCompass');
}
function showFollowCompass() {
  $.post('https://plus-hud/showFollowCompass');
}
function openMenuSounds() {
  $.post('https://plus-hud/openMenuSounds');
}
function resetHudSounds() {
  $.post('https://plus-hud/resetHudSounds');
}
function checklistSounds() {
  $.post('https://plus-hud/checklistSounds');
}
function showMapNotif() {
  $.post('https://plus-hud/showMapNotif');
}
function showFuelAlert() {
  $.post('https://plus-hud/showFuelAlert');
}
function showCinematicNotif() {
  $.post('https://plus-hud/showCinematicNotif');
}
function dynamicHealth() {
  $.post('https://plus-hud/dynamicHealth');
}
function dynamicArmor() {
  $.post('https://plus-hud/dynamicArmor');
}
function dynamicHunger() {
  $.post('https://plus-hud/dynamicHunger');
}
function dynamicThirst() {
  $.post('https://plus-hud/dynamicThirst');
}
function dynamicStress() {
  $.post('https://plus-hud/dynamicStress');
}
function dynamicOxygen() {
  $.post('https://plus-hud/dynamicOxygen');
}
function dynamicEngine() {
  $.post('https://plus-hud/dynamicEngine');
}
function dynamicNitro() {
  $.post('https://plus-hud/dynamicNitro');
}
function ToggleMapShape() {
  $.post('https://plus-hud/ToggleMapShape');
}
function changeFPS() {
  $.post('https://plus-hud/changeFPS');
}
function ToggleMapBorders() {
  $.post('https://plus-hud/ToggleMapBorders');
}
function HideMap() {
  $.post('https://plus-hud/HideMap');
}
function changeCompassFPS() {
  $.post('https://plus-hud/changeCompassFPS');
}
function showCompassBase() {
  $.post('https://plus-hud/showCompassBase');
}
function showStreetsNames() {
  $.post('https://plus-hud/showStreetsNames');
}
function showPointerIndex() {
  $.post('https://plus-hud/showPointerIndex');
}
function showDegreesNum() {
  $.post('https://plus-hud/showDegreesNum');
}
function cinematicMode() {
  $.post('https://plus-hud/cinematicMode');
}
