  ...
  ["index"] = { -- This can be a string or a number
    ...
    options = { -- This is your options table, in this table all the options will be specified for the target to accept
      { -- This is the first table with options, you can make as many options inside the options table as you want
        ...
        event = "Test:Event", -- This is the event it will trigger on click, this can be a client event, server event, command or PlusCore registered command, NOTICE: Normal command can't have arguments passed through, PlusCore registered ones can have arguments passed through
