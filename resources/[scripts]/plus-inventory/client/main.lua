...
local UserData = PlusCore.func.GetUserData()
...
local function HasItem(items, amount)
    ...
    for _, itemData in pairs(UserData.items) do
        if isTable then
                ...
                for key, value in pairs(exports['qb-weapons']:getConfigWeaponAttachments(itemdata.name)) do
                    if value.component == v.component then
                        ...
                        attachments[#attachments+1] = {
                            attachment = key,
                            label = PlusCore.Shared.Items[item].label
                            --label = value.label
                        }
                    end
                end
...
local function OpenTrunk()
    local vehicle = PlusCore.func.GetClosestVehicle()
...
local function ItemsToItemInfo()
	local itemInfos = {
		[1] = {costs = PlusCore.Shared.Items["metalscrap"]["label"] .. ": 22x, " ..PlusCore.Shared.Items["plastic"]["label"] .. ": 32x."},
		[2] = {costs = PlusCore.Shared.Items["metalscrap"]["label"] .. ": 30x, " ..PlusCore.Shared.Items["plastic"]["label"] .. ": 42x."},
		[3] = {costs = PlusCore.Shared.Items["metalscrap"]["label"] .. ": 30x, " ..PlusCore.Shared.Items["plastic"]["label"] .. ": 45x, "..PlusCore.Shared.Items["aluminum"]["label"] .. ": 28x."},
		[4] = {costs = PlusCore.Shared.Items["electronickit"]["label"] .. ": 2x, " ..PlusCore.Shared.Items["plastic"]["label"] .. ": 52x, "..PlusCore.Shared.Items["steel"]["label"] .. ": 40x."},
		[5] = {costs = PlusCore.Shared.Items["metalscrap"]["label"] .. ": 10x, " ..PlusCore.Shared.Items["plastic"]["label"] .. ": 50x, "..PlusCore.Shared.Items["aluminum"]["label"] .. ": 30x, "..PlusCore.Shared.Items["iron"]["label"] .. ": 17x, "..PlusCore.Shared.Items["electronickit"]["label"] .. ": 1x."},
		[6] = {costs = PlusCore.Shared.Items["metalscrap"]["label"] .. ": 36x, " ..PlusCore.Shared.Items["steel"]["label"] .. ": 24x, "..PlusCore.Shared.Items["aluminum"]["label"] .. ": 28x."},
		[7] = {costs = PlusCore.Shared.Items["metalscrap"]["label"] .. ": 32x, " ..PlusCore.Shared.Items["steel"]["label"] .. ": 43x, "..PlusCore.Shared.Items["plastic"]["label"] .. ": 61x."},
		[8] = {costs = PlusCore.Shared.Items["metalscrap"]["label"] .. ": 50x, " ..PlusCore.Shared.Items["steel"]["label"] .. ": 37x, "..PlusCore.Shared.Items["copper"]["label"] .. ": 26x."},
		[9] = {costs = PlusCore.Shared.Items["iron"]["label"] .. ": 60x, " ..PlusCore.Shared.Items["glass"]["label"] .. ": 30x."},
		[10] = {costs = PlusCore.Shared.Items["aluminum"]["label"] .. ": 60x, " ..PlusCore.Shared.Items["glass"]["label"] .. ": 30x."},
		[11] = {costs = PlusCore.Shared.Items["iron"]["label"] .. ": 33x, " ..PlusCore.Shared.Items["steel"]["label"] .. ": 44x, "..PlusCore.Shared.Items["plastic"]["label"] .. ": 55x, "..PlusCore.Shared.Items["aluminum"]["label"] .. ": 22x."},
		[12] = {costs = PlusCore.Shared.Items["iron"]["label"] .. ": 50x, " ..PlusCore.Shared.Items["steel"]["label"] .. ": 50x, "..PlusCore.Shared.Items["screwdriverset"]["label"] .. ": 3x, "..PlusCore.Shared.Items["advancedlockpick"]["label"] .. ": 2x."},
	}
...
local function SetupAttachmentItemsInfo()
	local itemInfos = {
		[1] = {costs = PlusCore.Shared.Items["metalscrap"]["label"] .. ": 140x, " .. PlusCore.Shared.Items["steel"]["label"] .. ": 250x, " .. PlusCore.Shared.Items["rubber"]["label"] .. ": 60x"},
		[2] = {costs = PlusCore.Shared.Items["metalscrap"]["label"] .. ": 165x, " .. PlusCore.Shared.Items["steel"]["label"] .. ": 285x, " .. PlusCore.Shared.Items["rubber"]["label"] .. ": 75x"},
		[3] = {costs = PlusCore.Shared.Items["metalscrap"]["label"] .. ": 190x, " .. PlusCore.Shared.Items["steel"]["label"] .. ": 305x, " .. PlusCore.Shared.Items["rubber"]["label"] .. ": 85x, " .. PlusCore.Shared.Items["smg_extendedclip"]["label"] .. ": 1x"},
		[4] = {costs = PlusCore.Shared.Items["metalscrap"]["label"] .. ": 205x, " .. PlusCore.Shared.Items["steel"]["label"] .. ": 340x, " .. PlusCore.Shared.Items["rubber"]["label"] .. ": 110x, " .. PlusCore.Shared.Items["smg_extendedclip"]["label"] .. ": 2x"},
		[5] = {costs = PlusCore.Shared.Items["metalscrap"]["label"] .. ": 230x, " .. PlusCore.Shared.Items["steel"]["label"] .. ": 365x, " .. PlusCore.Shared.Items["rubber"]["label"] .. ": 130x"},
		[6] = {costs = PlusCore.Shared.Items["metalscrap"]["label"] .. ": 255x, " .. PlusCore.Shared.Items["steel"]["label"] .. ": 390x, " .. PlusCore.Shared.Items["rubber"]["label"] .. ": 145x"},
		[7] = {costs = PlusCore.Shared.Items["metalscrap"]["label"] .. ": 270x, " .. PlusCore.Shared.Items["steel"]["label"] .. ": 435x, " .. PlusCore.Shared.Items["rubber"]["label"] .. ": 155x"},
		[8] = {costs = PlusCore.Shared.Items["metalscrap"]["label"] .. ": 300x, " .. PlusCore.Shared.Items["steel"]["label"] .. ": 469x, " .. PlusCore.Shared.Items["rubber"]["label"] .. ": 170x"},
	}
...
local function GetThresholdItems()
	...
	for k in pairs(Config.CraftingItems) do
		if UserData.metadata["craftingrep"] >= Config.CraftingItems[k].threshold then
...
local function GetAttachmentThresholdItems()
	...
	for k in pairs(Config.AttachmentCrafting["items"]) do
		if UserData.metadata["attachmentcraftingrep"] >= Config.AttachmentCrafting["items"][k].threshold then
...
RegisterNetEvent('QBCore:Client:OnPlayerLoaded', function()
    ...
    UserData = PlusCore.func.GetUserData()
    PlusCore.func.TriggerCallback("inventory:server:GetCurrentDrops", function(theDrops)
		Drops = theDrops
    end)
end)
...
RegisterNetEvent('QBCore:Player:SetUserData', function(val)
    UserData = val
end)
...
RegisterNetEvent('inventory:client:CheckOpenState', function(type, id, label)
    local name = PlusCore.Shared.SplitStr(label, "-")[2]
    if type == "stash" then
    ...
    if bool then
        for k in pairs(items) do
            itemTable[#itemTable+1] = {
                item = items[k].name,
                label = PlusCore.Shared.Items[items[k].name]["label"],
                image = items[k].image,
            }
        end
    end
...
RegisterNetEvent('inventory:client:CraftItems', function(itemName, itemCosts, amount, toSlot, points)
    ...
    isCrafting = true
    PlusCore.func.Progressbar("repair_vehicle", Lang:t("progress.crafting"), (math.random(2000, 5000) * amount), false, true, {
	    ...
	    StopAnimTask(ped, "mini@repair", "fixing_a_player", 1.0)
            ...
            TriggerEvent('inventory:client:ItemBox', PlusCore.Shared.Items[itemName], 'add')
            isCrafting = false
	end, function() -- Cancel
	    StopAnimTask(ped, "mini@repair", "fixing_a_player", 1.0)
            PlusCore.func.Notify(Lang:t("notify.failed"), "error")
            isCrafting = false
	end)
end)
...
RegisterNetEvent('inventory:client:PickupSnowballs', function()
    ...
    PlusCore.func.Progressbar("pickupsnowball", Lang:t("progress.snowballs"), 1500, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
	...
	TriggerServerEvent('inventory:server:snowball', 'add')
        TriggerEvent('inventory:client:ItemBox', PlusCore.Shared.Items["snowball"], "add")
    end, function() -- Cancel
        ClearPedTasks(ped)
        PlusCore.func.Notify(Lang:t("notify.canceled"), "error")
    end)
end)
...
RegisterCommand('inventory', function()
    ...
    if not isCrafting and not inInventory then
            ...
            if IsPedInAnyVehicle(ped, false) then -- Is Player In Vehicle
                ...
                CurrentGlovebox = PlusCore.func.GetPlate(vehicle)
                curVeh = vehicle
                CurrentVehicle = nil
            else
                local vehicle = PlusCore.func.GetClosestVehicle()
		    ...
		    local trunkpos = GetOffsetFromEntityInWorldCoords(vehicle, 0.0, (dimensionMin.y), 0.0)
                    ...
                    if #(pos - trunkpos) < 1.5 and not IsPedInAnyVehicle(ped) then
                        if GetVehicleDoorLockStatus(vehicle) < 2 then
                            CurrentVehicle = PlusCore.func.GetPlate(vehicle)
                            curVeh = vehicle
                            CurrentGlovebox = nil
                        else
                            PlusCore.func.Notify(Lang:t("notify.vlocked"), "error")
                            return
                        end
                    else
                        CurrentVehicle = nil
...
RegisterCommand('hotbar', function()
    ...
    if not UserData.metadata["isdead"] and not UserData.metadata["inlaststand"] and not UserData.metadata["ishandcuffed"] and not IsPauseMenuActive() then
...
for i = 1, 6 do
    RegisterCommand('slot' .. i,function()
        if not UserData.metadata["isdead"] and not UserData.metadata["inlaststand"] and not UserData.metadata["ishandcuffed"] and not IsPauseMenuActive() and not LocalPlayer.state.inv_busy then
            if i == 6 then
...
RegisterNUICallback('Notify', function(data, cb)
    PlusCore.func.Notify(data.message, data.type)
    cb('ok')
end)

RegisterNUICallback('GetWeaponData', function(cData, cb)
    local data = {
        WeaponData = PlusCore.Shared.Items[cData.weapon],
...
RegisterNUICallback('RemoveAttachment', function(data, cb)
    local ped = PlayerPedId()
    local WeaponData = PlusCore.Shared.Items[data.WeaponData.name]
    local Attachment = exports['qb-weapons']:getConfigWeaponAttachments(WeaponData.name:upper())[data.AttachmentData.attachment]
    PlusCore.func.TriggerCallback('weapons:server:RemoveAttachment', function(NewAttachments)
...
RegisterNUICallback('getCombineItem', function(data, cb)
    cb(PlusCore.Shared.Items[data.item])
end)
...
RegisterNUICallback('combineWithAnim', function(data, cb)
    ...
    PlusCore.func.Progressbar("combine_anim", animText, animTimeout, false, true, {
...
RegisterNUICallback("GiveItem", function(data, cb)
    local player, distance = PlusCore.func.GetClosestPlayer(GetEntityCoords(PlayerPedId()))
    if player ~= -1 and distance < 3 then
        if data.inventory == 'player' then
            ...
            PlusCore.func.Notify(Lang:t("notify.notowned"), "error")
        end
    else
        PlusCore.func.Notify(Lang:t("notify.nonb"), "error")
    end
    cb('ok')
end)
